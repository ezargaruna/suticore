...
elements   · fire water air   · alchemical states
...
```text
run/workflows/                    github actions for ci hygiene
...
threads    @ezargaruna
github     [github.com/ezargaruna](https://github.com/ezargaruna)
linkedin   [linkedin.com/in/ezargaruna](https://linkedin.com/in/ezargaruna)
...
├── sreteniya_os_v2026.md      canonical reference file
│
...
│   ├── scripts/               vault tools
│   │   ├── README.md          invocation patterns
│   │   ├── sreteniya_scan.sh
│   │   ├── sreteniya_filetypes.sh
│   │   ├── sreteniya_metadata.sh
│   │   ├── sreteniya_duplicates.sh
│   │   ├── sreteniya_clean_duplicates.sh
│   │   ├── sreteniya_similarity_scan.sh
│   │   ├── sreteniya_llm_pipeline.py
│   │   ├── vault_crystallizer.py
│   │   └── void_sweeper.sh
│   └── workflows/             github actions
│       └── sreteniya-os.yml   deploy workflow
│
